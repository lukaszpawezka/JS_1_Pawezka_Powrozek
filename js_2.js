...
function jakaLiczba() {
 ...
 if (liczbaINT > 0) {
  ...
  document.getElementById("parsInt").innerHTML="Ta liczba jest ujenna.";
 }
 else if (liczbaINT === "0"){
  document.getElementById("parsInt").innerHTML="Ta liczba jest równa zero.";
 }
 if (liczbaFLOAT > 0) {
  document.getElementById("parsFloat").innerHTML="Ta liczba jest dodatnia.";
 }
 else if(liczbaFLOAT < 0) {
  document.getElementById("parsFloat").innerHTML="Ta liczba jest ujenna.";
 }
 else if (liczbaFLOAT === "0"){
  document.getElementById("parsFloat").innerHTML="Ta liczba jest równa zero.";
 }
}
function jakiDzien(){
 var dzien;
